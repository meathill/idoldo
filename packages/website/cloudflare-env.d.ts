/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 3a15cdbdc67e69f44ee1c5f08957fed2)
// Runtime types generated with workerd@1.20260114.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface Env {
    NEXT_PUBLIC_SITE_URL: 'https://idoldo.com';
    NEXTJS_ENV: string;
    NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
    DB: D1Database;
    WORKER_SELF_REFERENCE: Fetcher /* idoldo-website */;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'NEXT_PUBLIC_SITE_URL' | 'NEXTJS_ENV'>> {}
}
